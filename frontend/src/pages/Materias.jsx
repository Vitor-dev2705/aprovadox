...
function MateriaCard({ materia, onEdit, onDelete, onAddConteudo }) {
  ...
  const horas = formatarTempo(materia.horas_estudadas)
        ...
        <div className="flex items-start justify-between gap-3 mb-4">
          <div className="flex items-center gap-3">
            <div
              ...
              style={{
                backgroundColor: materia.cor + '25',
            ...
            <div>
              ...
              <div className="flex items-center gap-3 text-xs text-slate-500 mt-0.5">
                <span className="flex items-center gap-1">
                  <FiClock size={11} /> {horas}
                </span>

                <span className="flex items-center gap-1">
                  <FiList size={11} /> {conteudos.length || materia.total_conteudos || '0'} conteúdos
                </span>
              </div>
            </div>
          </div>
            ...
            >
              <div className="pt-4 mt-4 border-t border-white/5">
                  ...
                  <div className="space-y-2">
                    {conteudos.map(c => (
                      <ConteudoItem
                        ...
                        onEdit={(item) =>
                          onAddConteudo(materia, item, loadConteudos)
                        }
                      />
                    ))}
                  </div>
                ...
                <Button
                  ...
                  onClick={() =>
                    onAddConteudo(materia, null, loadConteudos)
                  }
                  icon={<FiPlus size={12} />}
                >
                  Adicionar Conteúdo
